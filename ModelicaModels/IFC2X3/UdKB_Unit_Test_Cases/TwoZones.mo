...
model TwoZones
  ...
  equation
    ...
    connect(door_1.toSurfacePort_2, zone_2.toConstructionPorts[7]);
    ...
    connect(slab_4.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[10]);
    connect(window_1.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[11]);
    connect(door_2.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[12]);
  ...
  annotation(experiment(StartTime=0, StopTime=31536000, __Dymola_Algorithm="Dassl"),
    __Dymola_Commands(file="modelica://ModelicaModels/Resources/Scripts/Dymola/IFC2X3/UdKB_Unit_Test_Cases/TwoZones.mos" "Simulate and plot"),
