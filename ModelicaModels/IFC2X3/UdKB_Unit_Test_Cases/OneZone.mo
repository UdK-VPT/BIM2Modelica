...
// CoTeTo code generator IFC_MultiZoneBuildings_Modelica on Tue Mar 26 12:47:13 2019
//
...
model OneZone
  ...
  equation
    ...
    connect(window_1.toSurfacePort_2, surfacesToAmbient.toConstructionPorts[7]);
    connect(door_1.toSurfacePort_2, surfacesToAmbient.toConstructionPorts[8]);
