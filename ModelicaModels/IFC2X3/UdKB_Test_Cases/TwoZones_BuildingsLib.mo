...
// CoTeTo code generator IFC_MultiZoneBuildings_Modelica on Mon Apr  1 01:32:38 2019
//
...
equation
  ...
  connect(wall_2.port_a, zone_1.surf_surBou[2])
    annotation (Line(points={{62.2,26},{62,26},{62,-10},{80,-10}}, color={191,0,0}));
  connect(door_1.port_b, zone_2.surf_surBou[1])
    annotation (Line(points={{62.2,26},{62,26},{62,-10},{80,-10}}, color={191,0,0}));
