...
// CoTeTo code generator IFC_MultiZoneBuildings_Modelica on Mon Apr  1 01:32:34 2019
//
...
model OneZone_BuildingsLib
  ...
  Modelica.Blocks.Routing.Replicator replicator(nout=max(1,1))
