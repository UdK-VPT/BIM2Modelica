...
// CoTeTo code generator IFC_MultiZoneBuildings_Modelica on Mon Apr  1 01:38:09 2019
//
...
model CSC6_SB_BuildingsLib
  ...
  Buildings.ThermalZones.Detailed.MixedAir zone_1(
    ...
    AFlo=199.35725666117693,
    hRoo=3.7999999999999985,
    nConExt=5,
    datConExt(
      layers={
        matLayExt,
...
equation
  ...
  connect(slab_2.port_b, zone_2.surf_surBou[1])
    annotation (Line(points={{62.2,26},{62,26},{62,-10},{80,-10}}, color={191,0,0}));
