...
// CoTeTo code generator IFC_MultiZoneBuildings_Modelica on Tue Mar 26 12:33:56 2019
//
...
model SOAW3_SB
  ...
  equation
    ...
    connect(slab_8.toSurfacePort_2, surfacesToAmbient.toConstructionPorts[7]);
    ...
    connect(slab_10.toSurfacePort_2, surfacesToAmbient.toConstructionPorts[11]);
    connect(slab_11.toSurfacePort_2, surfacesToAmbient.toConstructionPorts[12]);
    connect(slab_12.toSurfacePort_2, surfacesToAmbient.toConstructionPorts[13]);
    connect(wall_12.toSurfacePort_2, surfacesToAmbient.toConstructionPorts[14]);
    connect(slab_13.toSurfacePort_2, surfacesToAmbient.toConstructionPorts[15]);
