...
// CoTeTo code generator IFC_MultiZoneBuildings_Modelica on Tue Mar  3 21:07:33 2020
//
...
model CSW3_SB
  ...
  equation
    ...
    connect(slab_1.toSurfacePort_1, zone_1.toConstructionPorts[9]);
    connect(slab_2.toSurfacePort_1, zone_1.toConstructionPorts[10]);
    connect(wall_5.toSurfacePort_2, zone_2.toConstructionPorts[1]);
    connect(wall_6.toSurfacePort_2, zone_2.toConstructionPorts[2]);
    connect(wall_7.toSurfacePort_2, zone_2.toConstructionPorts[3]);
    connect(wall_8.toSurfacePort_2, zone_2.toConstructionPorts[4]);
    ...
    connect(slab_5.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[11]);
