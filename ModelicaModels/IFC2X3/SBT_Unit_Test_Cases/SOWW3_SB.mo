...
model SOWW3_SB
  ...
  equation
    ...
    connect(wall_11.toSurfacePort_2, zone_5.toConstructionPorts[2]);
    ...
    connect(wall_12.toSurfacePort_1, zone_4.toConstructionPorts[1]);
    connect(wall_13.toSurfacePort_1, zone_4.toConstructionPorts[2]);
    connect(wall_14.toSurfacePort_1, zone_4.toConstructionPorts[3]);
    connect(slab_7.toSurfacePort_1, zone_4.toConstructionPorts[4]);
