...
model SOWW3_SB
  ...
  model Building
    ...
    nZones = 5,
    surfacesToAmbient(nSurfaces = 26),
    nSurfacesSolid = 0,
    ...
    BuildingSystems.Buildings.Constructions.Walls.WallThermal1DNodes slab_8(
      ...
      angleDegTil = 0.0,
      AInnSur = 0.0,
      height = 2.0000000000000036,
      width = 4.800000221066517);
  ...
  equation
    ...
    connect(wall_2.toSurfacePort_2, zone_1.toConstructionPorts[3]);
    connect(wall_3.toSurfacePort_1, zone_1.toConstructionPorts[4]);
    connect(wall_4.toSurfacePort_1, zone_1.toConstructionPorts[5]);
    connect(wall_5.toSurfacePort_1, zone_1.toConstructionPorts[6]);
    connect(slab_1.toSurfacePort_1, zone_1.toConstructionPorts[7]);
    connect(slab_2.toSurfacePort_1, zone_1.toConstructionPorts[8]);
    connect(slab_3.toSurfacePort_1, zone_1.toConstructionPorts[9]);
    connect(slab_4.toSurfacePort_1, zone_1.toConstructionPorts[10]);
    connect(slab_5.toSurfacePort_1, zone_1.toConstructionPorts[11]);
    connect(slab_6.toSurfacePort_1, zone_1.toConstructionPorts[12]);
    connect(wall_6.toSurfacePort_1, zone_2.toConstructionPorts[1]);
    connect(wall_7.toSurfacePort_1, zone_2.toConstructionPorts[2]);
    connect(wall_8.toSurfacePort_1, zone_2.toConstructionPorts[3]);
    connect(wall_9.toSurfacePort_1, zone_2.toConstructionPorts[4]);
    connect(slab_7.toSurfacePort_1, zone_2.toConstructionPorts[5]);
    connect(slab_8.toSurfacePort_1, zone_2.toConstructionPorts[6]);
    connect(slab_9.toSurfacePort_1, zone_2.toConstructionPorts[7]);
    connect(slab_8.toSurfacePort_2, zone_3.toConstructionPorts[1]);
    ...
    connect(slab_10.toSurfacePort_1, zone_3.toConstructionPorts[5]);
    connect(slab_9.toSurfacePort_2, zone_5.toConstructionPorts[1]);
    connect(wall_12.toSurfacePort_2, zone_5.toConstructionPorts[2]);
    connect(wall_15.toSurfacePort_2, zone_5.toConstructionPorts[3]);
    connect(wall_16.toSurfacePort_1, zone_5.toConstructionPorts[4]);
    connect(wall_17.toSurfacePort_1, zone_5.toConstructionPorts[5]);
    connect(wall_18.toSurfacePort_1, zone_5.toConstructionPorts[6]);
    connect(slab_13.toSurfacePort_1, zone_5.toConstructionPorts[7]);
    connect(wall_13.toSurfacePort_1, zone_4.toConstructionPorts[1]);
    connect(wall_14.toSurfacePort_1, zone_4.toConstructionPorts[2]);
    connect(wall_15.toSurfacePort_1, zone_4.toConstructionPorts[3]);
    connect(slab_11.toSurfacePort_1, zone_4.toConstructionPorts[4]);
    connect(slab_12.toSurfacePort_1, zone_4.toConstructionPorts[5]);
    ...
    connect(wall_6.toSurfacePort_2, surfacesToAmbient.toConstructionPorts[11]);
    connect(wall_7.toSurfacePort_2, surfacesToAmbient.toConstructionPorts[12]);
    connect(wall_8.toSurfacePort_2, surfacesToAmbient.toConstructionPorts[13]);
    connect(wall_9.toSurfacePort_2, surfacesToAmbient.toConstructionPorts[14]);
    connect(slab_7.toSurfacePort_2, surfacesToAmbient.toConstructionPorts[15]);
    connect(wall_10.toSurfacePort_2, surfacesToAmbient.toConstructionPorts[16]);
    connect(wall_11.toSurfacePort_2, surfacesToAmbient.toConstructionPorts[17]);
    connect(slab_10.toSurfacePort_2, surfacesToAmbient.toConstructionPorts[18]);
    connect(wall_13.toSurfacePort_2, surfacesToAmbient.toConstructionPorts[19]);
    connect(wall_14.toSurfacePort_2, surfacesToAmbient.toConstructionPorts[20]);
    connect(slab_11.toSurfacePort_2, surfacesToAmbient.toConstructionPorts[21]);
    connect(slab_12.toSurfacePort_2, surfacesToAmbient.toConstructionPorts[22]);
    connect(wall_16.toSurfacePort_2, surfacesToAmbient.toConstructionPorts[23]);
    connect(wall_17.toSurfacePort_2, surfacesToAmbient.toConstructionPorts[24]);
    connect(wall_18.toSurfacePort_2, surfacesToAmbient.toConstructionPorts[25]);
    connect(slab_13.toSurfacePort_2, surfacesToAmbient.toConstructionPorts[26]);
