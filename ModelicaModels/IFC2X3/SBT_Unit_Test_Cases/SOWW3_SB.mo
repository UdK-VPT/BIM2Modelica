...
// CoTeTo code generator IFC_MultiZoneBuildings_Modelica on Tue Mar  3 21:08:40 2020
//
...
model SOWW3_SB
  ...
  model Building
    ...
    nZones = 6,
    surfacesToAmbience(nSurfaces = 24),
    nSurfacesSolid = 0,
  ...
  equation
    ...
    connect(slab_8.toSurfacePort_1, zone_3.toConstructionPorts[7]);
    ...
    connect(slab_10.toSurfacePort_1, zone_5.toConstructionPorts[5]);
    connect(slab_5.toSurfacePort_2, zone_6.toConstructionPorts[1]);
    connect(slab_8.toSurfacePort_2, zone_6.toConstructionPorts[2]);
    connect(wall_14.toSurfacePort_2, zone_6.toConstructionPorts[3]);
    connect(wall_17.toSurfacePort_2, zone_6.toConstructionPorts[4]);
    connect(wall_18.toSurfacePort_1, zone_6.toConstructionPorts[5]);
    connect(wall_19.toSurfacePort_1, zone_6.toConstructionPorts[6]);
    connect(wall_20.toSurfacePort_1, zone_6.toConstructionPorts[7]);
    connect(slab_11.toSurfacePort_1, zone_6.toConstructionPorts[8]);
    connect(slab_7.toSurfacePort_2, zone_4.toConstructionPorts[1]);
    ...
    connect(slab_9.toSurfacePort_1, zone_4.toConstructionPorts[5]);
    ...
    connect(slab_3.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[10]);
    connect(wall_9.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[11]);
    connect(wall_10.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[12]);
    connect(wall_11.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[13]);
    ...
    connect(wall_15.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[18]);
    connect(wall_16.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[19]);
    connect(slab_10.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[20]);
    connect(wall_18.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[21]);
    connect(wall_19.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[22]);
    connect(wall_20.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[23]);
  ...
  annotation(experiment(StartTime=0, StopTime=31536000, __Dymola_Algorithm="Dassl"),
    __Dymola_Commands(file="modelica://ModelicaModels/Resources/Scripts/Dymola/IFC2X3/SBT_Unit_Test_Cases/SOWW3_SB.mos" "Simulate and plot"),
