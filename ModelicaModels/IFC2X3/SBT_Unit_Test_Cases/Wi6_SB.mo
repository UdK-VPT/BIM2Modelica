...
// CoTeTo code generator IFC_MultiZoneBuildings_Modelica on Thu Sep  5 15:20:04 2019
//
...
model Wi6_SB
  ...
  equation
    ...
    connect(window_2.toSurfacePort_1, zone_1.toConstructionPorts[8]);
    ...
    connect(window_2.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[12]);
  ...
  annotation(experiment(StartTime=0, StopTime=31536000, __Dymola_Algorithm="Dassl"),
    __Dymola_Commands(file="modelica://ModelicaModels/Resources/Scripts/Dymola/IFC2X3/SBT_Unit_Test_Cases/Wi6_SB.mos" "Simulate and plot"),
