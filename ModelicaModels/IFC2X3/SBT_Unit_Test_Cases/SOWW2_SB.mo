...
// CoTeTo code generator IFC_MultiZoneBuildings_Modelica on Thu Sep  5 15:19:01 2019
//
...
model SOWW2_SB
  ...
  model Building
    ...
    nZones = 3,
    surfacesToAmbience(nSurfaces = 14),
    nSurfacesSolid = 0,
  ...
  equation
    ...
    connect(slab_2.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[10]);
    ...
    connect(slab_3.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[14]);
  ...
  annotation(experiment(StartTime=0, StopTime=31536000, __Dymola_Algorithm="Dassl"),
    __Dymola_Commands(file="modelica://ModelicaModels/Resources/Scripts/Dymola/IFC2X3/SBT_Unit_Test_Cases/SOWW2_SB.mos" "Simulate and plot"),
