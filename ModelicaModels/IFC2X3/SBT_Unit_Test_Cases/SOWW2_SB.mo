...
// CoTeTo code generator IFC_MultiZoneBuildings_Modelica on Tue Mar 26 12:34:16 2019
//
...
model SOWW2_SB
  ...
  equation
    ...
    connect(slab_2.toSurfacePort_2, surfacesToAmbient.toConstructionPorts[10]);
    ...
    connect(slab_3.toSurfacePort_2, surfacesToAmbient.toConstructionPorts[14]);
