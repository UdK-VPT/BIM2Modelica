...
// CoTeTo code generator IFC_MultiZoneBuildings_Modelica on Thu Sep  5 15:18:21 2019
//
...
model SOAW1_SB
  ...
  model Building
    ...
    nZones = 5,
    surfacesToAmbience(nSurfaces = 18),
    nSurfacesSolid = 0,
    ...
    BuildingSystems.Buildings.Constructions.Walls.WallThermal1DNodes slab_6(
      ...
      angleDegTil = 0.0,
      AInnSur = 10.0,
      height = 5.000000021936639,
      width = 9.799999957015846);
  ...
  equation
    ...
    connect(slab_1.toSurfacePort_1, zone_1.toConstructionPorts[4]);
    connect(slab_2.toSurfacePort_1, zone_1.toConstructionPorts[5]);
    connect(slab_3.toSurfacePort_1, zone_1.toConstructionPorts[6]);
    connect(slab_2.toSurfacePort_2, zone_4.toConstructionPorts[1]);
    connect(slab_5.toSurfacePort_2, zone_4.toConstructionPorts[2]);
    connect(wall_7.toSurfacePort_1, zone_4.toConstructionPorts[3]);
    connect(wall_8.toSurfacePort_1, zone_4.toConstructionPorts[4]);
    connect(wall_9.toSurfacePort_1, zone_4.toConstructionPorts[5]);
    connect(slab_9.toSurfacePort_1, zone_4.toConstructionPorts[6]);
    ...
    connect(wall_12.toSurfacePort_1, zone_5.toConstructionPorts[5]);
    connect(slab_10.toSurfacePort_1, zone_5.toConstructionPorts[6]);
    connect(wall_4.toSurfacePort_1, zone_2.toConstructionPorts[1]);
    connect(wall_5.toSurfacePort_1, zone_2.toConstructionPorts[2]);
    connect(wall_6.toSurfacePort_1, zone_2.toConstructionPorts[3]);
    connect(slab_4.toSurfacePort_1, zone_2.toConstructionPorts[4]);
    connect(slab_5.toSurfacePort_1, zone_2.toConstructionPorts[5]);
    connect(slab_6.toSurfacePort_1, zone_2.toConstructionPorts[6]);
    connect(slab_7.toSurfacePort_1, zone_3.toConstructionPorts[1]);
    connect(slab_8.toSurfacePort_1, zone_3.toConstructionPorts[2]);
    ...
    connect(wall_4.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[5]);
    connect(wall_5.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[6]);
    connect(wall_6.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[7]);
    connect(slab_4.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[8]);
    connect(slab_7.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[9]);
    connect(slab_8.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[10]);
    connect(wall_7.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[11]);
    connect(wall_8.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[12]);
    connect(wall_9.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[13]);
    connect(slab_9.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[14]);
    connect(wall_10.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[15]);
    connect(wall_11.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[16]);
    connect(wall_12.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[17]);
    connect(slab_10.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[18]);
  ...
  annotation(experiment(StartTime=0, StopTime=31536000, __Dymola_Algorithm="Dassl"),
    __Dymola_Commands(file="modelica://ModelicaModels/Resources/Scripts/Dymola/IFC2X3/SBT_Unit_Test_Cases/SOAW1_SB.mos" "Simulate and plot"),
