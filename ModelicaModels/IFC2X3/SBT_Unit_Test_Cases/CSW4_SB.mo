...
// CoTeTo code generator IFC_MultiZoneBuildings_Modelica on Tue Mar  3 21:07:38 2020
//
...
model CSW4_SB
  ...
  model Building
    ...
    nZones = 4,
    surfacesToAmbience(nSurfaces = 16),
    nSurfacesSolid = 0,
  ...
  equation
    ...
    connect(slab_7.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[16]);
