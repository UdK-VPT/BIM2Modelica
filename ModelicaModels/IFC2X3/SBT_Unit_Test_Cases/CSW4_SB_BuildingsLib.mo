...
// CoTeTo code generator IFC_MultiZoneBuildings_Modelica on Wed Apr  3 09:41:05 2019
//
...
equation
  ...
  connect(slab_4.port_a, zone_2.surf_surBou[5])
    annotation (Line(points={{62.2,26},{62,26},{62,-10},{80,-10}}, color={191,0,0}));
  connect(wall_6.port_b, zone_3.surf_surBou[1])
    annotation (Line(points={{62.2,26},{62,26},{62,-10},{80,-10}}, color={191,0,0}));
  connect(wall_7.port_b, zone_3.surf_surBou[2])
    annotation (Line(points={{62.2,26},{62,26},{62,-10},{80,-10}}, color={191,0,0}));
