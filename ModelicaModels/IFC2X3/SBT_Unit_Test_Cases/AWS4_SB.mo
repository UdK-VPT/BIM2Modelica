...
// CoTeTo code generator IFC_MultiZoneBuildings_Modelica on Tue Mar  3 21:06:53 2020
//
...
model AWS4_SB
  ...
  equation
    ...
    connect(wall_5.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[1]);
    connect(wall_6.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[2]);
    connect(wall_7.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[3]);
    ...
    connect(slab_3.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[9]);
    connect(wall_11.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[10]);
  ...
  annotation(experiment(StartTime=0, StopTime=31536000, __Dymola_Algorithm="Dassl"),
    __Dymola_Commands(file="modelica://ModelicaModels/Resources/Scripts/Dymola/IFC2X3/SBT_Unit_Test_Cases/AWS4_SB.mos" "Simulate and plot"),
