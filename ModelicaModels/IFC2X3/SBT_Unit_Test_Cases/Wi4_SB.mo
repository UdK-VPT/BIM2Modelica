...
// CoTeTo code generator IFC_MultiZoneBuildings_Modelica on Thu Sep  5 15:19:59 2019
//
...
model Wi4_SB
  ...
  equation
    ...
    connect(window_1.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[14]);
    connect(window_2.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[15]);
