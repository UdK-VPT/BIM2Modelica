...
// CoTeTo code generator IFC_MultiZoneBuildings_Modelica on Tue Mar 26 12:32:40 2019
//
...
model CSC3_SB
  ...
  annotation(experiment(StartTime=0, StopTime=31536000, __Dymola_Algorithm="Dassl"),
    __Dymola_Commands(file="modelica://ModelicaModels/Resources/Scripts/Dymola/IFC2X3/SBT_Unit_Test_Cases/CSC3_SB.mos" "Simulate and plot"),
