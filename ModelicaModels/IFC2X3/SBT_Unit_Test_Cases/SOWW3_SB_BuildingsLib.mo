...
// CoTeTo code generator IFC_MultiZoneBuildings_Modelica on Wed Apr  3 09:42:14 2019
//
...
model SOWW3_SB_BuildingsLib
  ...
  Buildings.HeatTransfer.Conduction.MultiLayer slab_5(
    ...
    "Construction that is modeled outside of room"
    annotation (Placement(transformation(extent={{80,-20},{100,0}})));
  Buildings.HeatTransfer.Conduction.MultiLayer wall_11(
    A=7.6,
    layers=matLayPar,
    stateAtSurface_b=false)
    "Construction that is modeled outside of room"
...
equation
  ...
  connect(slab_4.port_a, zone_2.surf_surBou[1])
    annotation (Line(points={{62.2,26},{62,26},{62,-10},{80,-10}}, color={191,0,0}));
  connect(slab_5.port_a, zone_2.surf_surBou[2])
    annotation (Line(points={{62.2,26},{62,26},{62,-10},{80,-10}}, color={191,0,0}));
  connect(slab_4.port_b, zone_3.surf_surBou[1])
    annotation (Line(points={{62.2,26},{62,26},{62,-10},{80,-10}}, color={191,0,0}));
  connect(wall_11.port_a, zone_3.surf_surBou[2])
    annotation (Line(points={{62.2,26},{62,26},{62,-10},{80,-10}}, color={191,0,0}));
  connect(wall_14.port_a, zone_4.surf_surBou[1])
    annotation (Line(points={{62.2,26},{62,26},{62,-10},{80,-10}}, color={191,0,0}));
  connect(slab_5.port_b, zone_5.surf_surBou[1])
    annotation (Line(points={{62.2,26},{62,26},{62,-10},{80,-10}}, color={191,0,0}));
  connect(wall_11.port_b, zone_5.surf_surBou[2])
    annotation (Line(points={{62.2,26},{62,26},{62,-10},{80,-10}}, color={191,0,0}));
  connect(wall_14.port_b, zone_5.surf_surBou[3])
    annotation (Line(points={{62.2,26},{62,26},{62,-10},{80,-10}}, color={191,0,0}));
