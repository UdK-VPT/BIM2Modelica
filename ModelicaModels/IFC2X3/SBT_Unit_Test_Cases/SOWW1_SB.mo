...
model SOWW1_SB
  ...
  equation
    ...
    connect(slab_7.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[13]);
    ...
    connect(wall_15.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[16]);
    connect(wall_16.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[17]);
    connect(slab_9.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[18]);
    connect(wall_18.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[19]);
    connect(wall_19.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[20]);
    connect(wall_20.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[21]);
    connect(slab_10.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[22]);
