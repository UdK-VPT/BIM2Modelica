...
// CoTeTo code generator IFC_MultiZoneBuildings_Modelica on Tue Mar 26 12:33:07 2019
//
...
model CSW1_SB
  ...
  model Building
    ...
    nZones = 5,
    surfacesToAmbient(nSurfaces = 17),
    nSurfacesSolid = 0,
  ...
  equation
    ...
    connect(slab_7.toSurfacePort_1, zone_4.toConstructionPorts[6]);
    connect(slab_8.toSurfacePort_1, zone_4.toConstructionPorts[7]);
    ...
    connect(slab_2.toSurfacePort_2, zone_5.toConstructionPorts[1]);
    connect(slab_4.toSurfacePort_2, zone_5.toConstructionPorts[2]);
    connect(slab_6.toSurfacePort_2, zone_5.toConstructionPorts[3]);
    connect(slab_8.toSurfacePort_2, zone_5.toConstructionPorts[4]);
    connect(wall_14.toSurfacePort_1, zone_5.toConstructionPorts[5]);
    connect(wall_15.toSurfacePort_1, zone_5.toConstructionPorts[6]);
    connect(wall_16.toSurfacePort_1, zone_5.toConstructionPorts[7]);
    connect(wall_17.toSurfacePort_1, zone_5.toConstructionPorts[8]);
    connect(slab_9.toSurfacePort_1, zone_5.toConstructionPorts[9]);
    ...
    connect(slab_9.toSurfacePort_2, surfacesToAmbient.toConstructionPorts[17]);
  ...
  annotation(experiment(StartTime=0, StopTime=31536000, __Dymola_Algorithm="Dassl"),
    __Dymola_Commands(file="modelica://ModelicaModels/Resources/Scripts/Dymola/IFC2X3/SBT_Unit_Test_Cases/CSW1_SB.mos" "Simulate and plot"),
