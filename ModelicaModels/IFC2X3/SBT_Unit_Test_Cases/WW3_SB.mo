...
// CoTeTo code generator IFC_MultiZoneBuildings_Modelica on Thu Sep  5 15:20:15 2019
//
...
model WW3_SB
  ...
  equation
    ...
    connect(wall_6.toSurfacePort_2, zone_3.toConstructionPorts[2]);
    ...
    connect(slab_3.toSurfacePort_1, zone_2.toConstructionPorts[7]);
    ...
    connect(wall_14.toSurfacePort_1, zone_4.toConstructionPorts[6]);
    connect(wall_15.toSurfacePort_1, zone_4.toConstructionPorts[7]);
    ...
    connect(wall_9.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[6]);
    ...
    connect(slab_5.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[10]);
    connect(wall_12.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[11]);
    ...
    connect(wall_15.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[14]);
    connect(slab_7.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[15]);
  ...
  annotation(experiment(StartTime=0, StopTime=31536000, __Dymola_Algorithm="Dassl"),
    __Dymola_Commands(file="modelica://ModelicaModels/Resources/Scripts/Dymola/IFC2X3/SBT_Unit_Test_Cases/WW3_SB.mos" "Simulate and plot"),
