...
model WW3_SB
  ...
  model Building
    ...
    nZones = 4,
    surfacesToAmbient(nSurfaces = 15),
    nSurfacesSolid = 0,
  ...
  equation
    ...
    connect(wall_6.toSurfacePort_2, zone_1.toConstructionPorts[7]);
    ...
    connect(wall_10.toSurfacePort_1, zone_2.toConstructionPorts[6]);
    ...
    connect(wall_2.toSurfacePort_2, surfacesToAmbient.toConstructionPorts[1]);
    ...
    connect(wall_8.toSurfacePort_2, surfacesToAmbient.toConstructionPorts[4]);
    connect(wall_9.toSurfacePort_2, surfacesToAmbient.toConstructionPorts[5]);
    connect(wall_10.toSurfacePort_2, surfacesToAmbient.toConstructionPorts[6]);
    ...
    connect(slab_5.toSurfacePort_2, surfacesToAmbient.toConstructionPorts[10]);
    ...
    connect(wall_15.toSurfacePort_2, surfacesToAmbient.toConstructionPorts[13]);
  ...
  BuildingSystems.Buildings.Ambient ambient(
    ...
    BuildingSystems.Buildings.BaseClasses.RelationRadiationConvection relationRadiationConvection[4](each radiationportion = 0.5);
  equation
