...
// CoTeTo code generator IFC_MultiZoneBuildings_Modelica on Tue Mar 26 12:34:36 2019
//
...
model SWW3_SB
  ...
  equation
    ...
    connect(slab_1.toSurfacePort_2, surfacesToAmbient.toConstructionPorts[1]);
    connect(wall_5.toSurfacePort_2, surfacesToAmbient.toConstructionPorts[2]);
    connect(wall_6.toSurfacePort_2, surfacesToAmbient.toConstructionPorts[3]);
    connect(wall_7.toSurfacePort_2, surfacesToAmbient.toConstructionPorts[4]);
    ...
    connect(slab_6.toSurfacePort_2, surfacesToAmbient.toConstructionPorts[11]);
    connect(slab_7.toSurfacePort_2, surfacesToAmbient.toConstructionPorts[12]);
