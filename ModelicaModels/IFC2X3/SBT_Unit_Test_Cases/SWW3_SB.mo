...
// CoTeTo code generator IFC_MultiZoneBuildings_Modelica on Thu Sep  5 15:19:22 2019
//
...
model SWW3_SB
  ...
  equation
    ...
    connect(wall_3.toSurfacePort_2, zone_2.toConstructionPorts[3]);
    connect(wall_4.toSurfacePort_2, zone_2.toConstructionPorts[4]);
    connect(wall_5.toSurfacePort_1, zone_2.toConstructionPorts[5]);
    connect(wall_6.toSurfacePort_1, zone_2.toConstructionPorts[6]);
    connect(wall_7.toSurfacePort_1, zone_2.toConstructionPorts[7]);
    connect(wall_8.toSurfacePort_1, zone_2.toConstructionPorts[8]);
    ...
    connect(wall_13.toSurfacePort_2, zone_4.toConstructionPorts[3]);
    connect(wall_14.toSurfacePort_2, zone_4.toConstructionPorts[4]);
    connect(wall_15.toSurfacePort_2, zone_4.toConstructionPorts[5]);
    connect(wall_16.toSurfacePort_2, zone_4.toConstructionPorts[6]);
    connect(slab_7.toSurfacePort_1, zone_4.toConstructionPorts[7]);
    ...
    connect(wall_14.toSurfacePort_1, zone_3.toConstructionPorts[7]);
    connect(wall_15.toSurfacePort_1, zone_3.toConstructionPorts[8]);
    connect(wall_16.toSurfacePort_1, zone_3.toConstructionPorts[9]);
    connect(slab_6.toSurfacePort_1, zone_3.toConstructionPorts[10]);
    ...
    connect(wall_5.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[2]);
    connect(wall_6.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[3]);
    connect(wall_7.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[4]);
    ...
    connect(wall_9.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[7]);
    connect(wall_10.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[8]);
    ...
    connect(slab_7.toSurfacePort_2, surfacesToAmbience.toConstructionPorts[12]);
  ...
  annotation(experiment(StartTime=0, StopTime=31536000, __Dymola_Algorithm="Dassl"),
    __Dymola_Commands(file="modelica://ModelicaModels/Resources/Scripts/Dymola/IFC2X3/SBT_Unit_Test_Cases/SWW3_SB.mos" "Simulate and plot"),
