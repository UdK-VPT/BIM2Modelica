...
// CoTeTo code generator IFC_MultiZoneBuildings_Modelica on Wed Apr  3 09:41:23 2019
//
...
equation
  ...
  connect(slab_2.port_a, zone_1.surf_surBou[1])
    annotation (Line(points={{62.2,26},{62,26},{62,-10},{80,-10}}, color={191,0,0}));
  connect(slab_3.port_a, zone_1.surf_surBou[2])
    annotation (Line(points={{62.2,26},{62,26},{62,-10},{80,-10}}, color={191,0,0}));
  connect(slab_5.port_a, zone_2.surf_surBou[1])
    annotation (Line(points={{62.2,26},{62,26},{62,-10},{80,-10}}, color={191,0,0}));
  connect(slab_6.port_a, zone_2.surf_surBou[2])
    annotation (Line(points={{62.2,26},{62,26},{62,-10},{80,-10}}, color={191,0,0}));
