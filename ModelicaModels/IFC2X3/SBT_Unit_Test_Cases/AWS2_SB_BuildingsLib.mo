...
// CoTeTo code generator IFC_MultiZoneBuildings_Modelica on Mon Apr  1 01:37:28 2019
//
...
equation
  ...
  connect(wall_5.port_b, zone_3.surf_surBou[2])
    annotation (Line(points={{62.2,26},{62,26},{62,-10},{80,-10}}, color={191,0,0}));
  connect(slab_7.port_a, zone_3.surf_surBou[3])
    annotation (Line(points={{62.2,26},{62,26},{62,-10},{80,-10}}, color={191,0,0}));
  ...
  connect(wall_7.port_b, zone_5.surf_surBou[2])
    annotation (Line(points={{62.2,26},{62,26},{62,-10},{80,-10}}, color={191,0,0}));
  connect(slab_7.port_b, zone_5.surf_surBou[3])
    annotation (Line(points={{62.2,26},{62,26},{62,-10},{80,-10}}, color={191,0,0}));
  connect(wall_13.port_b, zone_5.surf_surBou[4])
    annotation (Line(points={{62.2,26},{62,26},{62,-10},{80,-10}}, color={191,0,0}));
