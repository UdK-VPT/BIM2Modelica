...
model AWS2_SB
  ...
  equation
    ...
    connect(slab_6.toSurfacePort_1, zone_2.toConstructionPorts[10]);
    ...
    connect(slab_8.toSurfacePort_2, zone_5.toConstructionPorts[3]);
    ...
    connect(slab_10.toSurfacePort_1, zone_5.toConstructionPorts[7]);
    ...
    connect(wall_16.toSurfacePort_2, surfacesToAmbient.toConstructionPorts[16]);
    connect(wall_17.toSurfacePort_2, surfacesToAmbient.toConstructionPorts[17]);
