...
// CoTeTo code generator IFC_MultiZoneBuildings_Modelica on Wed Apr  3 09:42:00 2019
//
...
model SOWW1_SB_BuildingsLib
  ...
  Buildings.ThermalZones.Detailed.MixedAir zone_4(
    redeclare package Medium = MediumA,
    AFlo=37.707687517219554,
    hRoo=7.799999999999999,
    nConExt=4,
    datConExt(
      layers={
        matLayExt,
  ...
  Buildings.HeatTransfer.Conduction.MultiLayer slab_3(
    ...
    "Construction that is modeled outside of room"
    annotation (Placement(transformation(extent={{80,-20},{100,0}})));
  Buildings.HeatTransfer.Conduction.MultiLayer slab_5(
    A=38.220000244999994,
    layers=matLayPar,
    stateAtSurface_b=false)
    "Construction that is modeled outside of room"
    annotation (Placement(transformation(extent={{80,-20},{100,0}})));
  Buildings.HeatTransfer.Conduction.MultiLayer slab_6(
    A=40.179998989999994,
    layers=matLayPar,
    stateAtSurface_b=false)
    "Construction that is modeled outside of room"
    annotation (Placement(transformation(extent={{80,-20},{100,0}})));
...
equation
  ...
  connect(wall_4.port_a, zone_1.surf_surBou[1])
    annotation (Line(points={{62.2,26},{62,26},{62,-10},{80,-10}}, color={191,0,0}));
  connect(wall_5.port_a, zone_1.surf_surBou[2])
    annotation (Line(points={{62.2,26},{62,26},{62,-10},{80,-10}}, color={191,0,0}));
  ...
  connect(wall_5.port_b, zone_2.surf_surBou[2])
    annotation (Line(points={{62.2,26},{62,26},{62,-10},{80,-10}}, color={191,0,0}));
  connect(slab_5.port_a, zone_2.surf_surBou[3])
    annotation (Line(points={{62.2,26},{62,26},{62,-10},{80,-10}}, color={191,0,0}));
  connect(slab_6.port_a, zone_2.surf_surBou[4])
    annotation (Line(points={{62.2,26},{62,26},{62,-10},{80,-10}}, color={191,0,0}));
  connect(slab_2.port_b, zone_4.surf_surBou[1])
    annotation (Line(points={{62.2,26},{62,26},{62,-10},{80,-10}}, color={191,0,0}));
  connect(slab_5.port_b, zone_4.surf_surBou[2])
    annotation (Line(points={{62.2,26},{62,26},{62,-10},{80,-10}}, color={191,0,0}));
  connect(wall_13.port_a, zone_4.surf_surBou[3])
    annotation (Line(points={{62.2,26},{62,26},{62,-10},{80,-10}}, color={191,0,0}));
  connect(wall_17.port_a, zone_4.surf_surBou[4])
    annotation (Line(points={{62.2,26},{62,26},{62,-10},{80,-10}}, color={191,0,0}));
  connect(slab_3.port_b, zone_5.surf_surBou[1])
    annotation (Line(points={{62.2,26},{62,26},{62,-10},{80,-10}}, color={191,0,0}));
  connect(slab_6.port_b, zone_5.surf_surBou[2])
    annotation (Line(points={{62.2,26},{62,26},{62,-10},{80,-10}}, color={191,0,0}));
  connect(wall_13.port_b, zone_5.surf_surBou[3])
    annotation (Line(points={{62.2,26},{62,26},{62,-10},{80,-10}}, color={191,0,0}));
  connect(wall_17.port_b, zone_5.surf_surBou[4])
    annotation (Line(points={{62.2,26},{62,26},{62,-10},{80,-10}}, color={191,0,0}));
