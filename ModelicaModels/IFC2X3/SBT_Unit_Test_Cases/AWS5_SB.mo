...
// CoTeTo code generator IFC_MultiZoneBuildings_Modelica on Tue Mar 26 12:32:28 2019
//
...
model AWS5_SB
  ...
  equation
    ...
    connect(window_2.toSurfacePort_1, zone_1.toConstructionPorts[9]);
    ...
    connect(window_1.toSurfacePort_2, zone_2.toConstructionPorts[7]);
    ...
    connect(slab_5.toSurfacePort_1, zone_3.toConstructionPorts[6]);
    connect(window_2.toSurfacePort_2, zone_3.toConstructionPorts[7]);
  ...
  annotation(experiment(StartTime=0, StopTime=31536000, __Dymola_Algorithm="Dassl"),
    __Dymola_Commands(file="modelica://ModelicaModels/Resources/Scripts/Dymola/IFC2X3/SBT_Unit_Test_Cases/AWS5_SB.mos" "Simulate and plot"),
