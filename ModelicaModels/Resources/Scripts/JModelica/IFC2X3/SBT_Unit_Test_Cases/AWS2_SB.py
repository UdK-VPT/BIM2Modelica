...
model_name = 'ModelicaModels.IFC2X3.SBT_Unit_Test_Cases.AWS2_SB'
...
y7 = res['building.zone_1.TOperative']
t = res['time']
P.subplot(2,1,1)
P.plot(t, y1, t, y2, t, y3, t, y4, t, y5, t, y6, t, y7)
P.legend(['ambience.TAirRef','building.zone_1.TAir','building.zone_2.TAir',
'building.zone_3.TAir','building.zone_4.TAir','building.zone_5.TAir','building.zone_1.TOperative'])
...
P.legend(['building.zone_1.Q_flow_heating','building.zone_2.Q_flow_heating','building.zone_3.Q_flow_heating','building.zone_4.Q_flow_heating','building.zone_5.Q_flow_heating'])
P.ylabel('power (W)')
P.xlabel('Time (s)')
P.show()
