...
model_name = 'ModelicaModels.IFC2X3.SBT_Unit_Test_Cases.CSC3_SB'
...
P.legend(['ambience.TAirRef','building.zone_1.TAir','building.zone_2.TAir','building.zone_1.TOperative'])
